...
CREATE TABLE `zaposlenje` (
  `ID_Zaposlenja` int(11) NOT NULL AUTO_INCREMENT,
  `ID_Korisnika` int(11) DEFAULT NULL,
  `Vrsta_Zaposlenja` varchar(255) DEFAULT NULL,
  `Datum_Od` date DEFAULT NULL,
  `Datum_Do` date DEFAULT NULL,
  PRIMARY KEY (`ID_Zaposlenja`),
  KEY `ID_Korisnika` (`ID_Korisnika`),
  CONSTRAINT `zaposlenje_ibfk_1` FOREIGN KEY (`ID_Korisnika`) REFERENCES `korisnik` (`ID_Korisnika`)
